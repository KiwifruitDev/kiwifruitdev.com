# Help Section
This article is provided to resolve common technical issues with Garry's Mod itself.

## 64-bit Support
If you're having problems with our services (such as repeated crashes, lack of HTML support, etc), please make sure you're running a 64-bit operating system and perform the following steps:
...
?> Copyright (C) 2021 Wildfire Servers<br>All rights reserved.
